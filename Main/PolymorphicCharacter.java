...
public class PolymorphicCharacter extends AbstractCharacter {
    ...
    public Pair<HashMap<Integer, HashSet<Integer>>, Integer> evolveCharacterGenetically(Vertex node, HashSet<Integer> current_state, int next_state, boolean stopAtReticulate) {
        ...
        for (Edge e : node.OutgoingEdges) {
            ...
            if (!stopAtReticulate || e.child.reticulateEdge == null) {
                Pair<HashMap<Integer, HashSet<Integer>>, Integer> hashMapIntegerPair = evolveCharacterGenetically(e.child, new_state, next_state, stopAtReticulate);
    ...
    public void handleReticulateEdge(ReticulateEdge retEdge, HashMap<Integer, HashSet<Integer>> stateMap) {
        ...
        if (dice < probability_transfer) {
            ...
            if (dice2 > 0.5) { // l2r
                ...
                System.out.println("Reticulate transfer L2R on character " + Integer.toString(id) + " at ret edge " + Integer.toString(retEdge.Id) + "!");
            } else { // r2l
                ...
                System.out.println("Reticulate transfer R2L on character " + Integer.toString(id) + " at ret edge " + Integer.toString(retEdge.Id) + "!");
            }
        }
    }
